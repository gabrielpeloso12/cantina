...
{$R *.dfm}
  ...
  uses clienteListaU, funcionarioListaU, produtoListaU, clienteDadosU, funcionarioDadosU, produtoDadosU, identificaClienteU, pontoVendaU, identificaClientePDVU, fastReportClienteU;
...
begin
    ...
    frmRelatorio.frxCliente.LoadFromFile(path+'relCliente.fr3');
    frmRelatorio.frxCliente.ShowReport();
end;
...
begin
    ...
    begin
      ...
      begin
        ...
        MessageBox(Application.Handle, Pchar('Formulario não encontrado!'), Pchar('Buscar de formulario'), MB_OK+MB_ICONINFORMATION);
